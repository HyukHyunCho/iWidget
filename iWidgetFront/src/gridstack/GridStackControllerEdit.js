...
function GridStackControllerEdit ({reducer,dashId}) {
  ...
  const makeWidget = (widgetItem) => {
    if(widgetItem.type === "type1") return <TestWidget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type2") return <DemoWidget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type3") return <Demo2Widget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type4") return <Demo3Widget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    //else if(widgetItem.type === "type5") return <StockChartWidget widgetInfo={widgetItem} dashId={props.dashId} setting={"on"} />
    else if(widgetItem.type === "type6") return <Demo4Widget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type7") return <Demo5Widget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type8") return <Demo6Widget widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
    else if(widgetItem.type === "type9") return <Test widgetInfo={widgetItem} dashId={dashId} setting={"on"} />
  ...
  const saveGrid = () => {
    ...
    const dashArr = ({
      dashid: reducer.dashboard[dashId].id,
      dashname: reducer.dashboard[dashId].dashname,
      web: webArr,
      tablet: tabletArr,
      mobile: mobileArr
    })
